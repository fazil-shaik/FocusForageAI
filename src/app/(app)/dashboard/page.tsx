...
export default async function Dashboard() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 relative">
            ...
            <div className="absolute -top-24 -left-24 w-64 h-64 md:w-96 md:h-96 bg-primary/10 blur-[80px] md:blur-[120px] rounded-full pointer-events-none -z-10 animate-pulse"></div>
            <div className="absolute top-1/2 -right-24 w-60 h-60 md:w-80 md:h-80 bg-accent/10 blur-[80px] md:blur-[100px] rounded-full pointer-events-none -z-10"></div>
            ...
            <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8 md:mb-12">
                <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-secondary/10 border border-border/50 rounded-2xl backdrop-blur-sm shadow-sm">
                            ...
                            <span className="text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-wider">Focus Score: <span className="text-foreground">{focusScore}/100</span></span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/10 border border-primary/20 rounded-2xl backdrop-blur-sm shadow-sm group hover:scale-105 transition-transform cursor-default">
                            ...
                            <span className="text-[10px] md:text-xs font-black text-primary tracking-wider">{user.xp || 0} XP</span>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
                    <Link
                        ...
                        className="text-[10px] font-black text-primary border border-primary/20 bg-primary/10 px-4 py-2.5 rounded-xl hover:bg-primary/20 transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/5 group"
                    >
